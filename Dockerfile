...
ENV \
    ...
    DISPLAY=:665
RUN  \
    wget --no-check-certificate -q "https://media.githubusercontent.com/media/dream10201/bdisk/refs/heads/master/baidunetdisk_4.17.7_amd64.deb?download=true" -O /tmp/tmp.deb \
